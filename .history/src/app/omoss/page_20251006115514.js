export default function OmOssPage() {
  return (
    <div className="w-full py-12">
      {/* NORYA Heading */}
      <h1 className="font-bold text-slate-900 mb-12 tracking-tight font-poppins text-[150px] lg:text-[220px] xl:text-[280px] 2xl:text-[320px] leading-none text-center md:text-left px-6 md:px-0 text-center">
        NORYA
      </h1>
