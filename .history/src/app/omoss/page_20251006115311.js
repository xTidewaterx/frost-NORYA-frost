export default function OmOssPage() {
  return (
    <div className="omoss-container px-6 py-12 max-w-full xl:max-w-[1920px] mx-auto">
      {/* NORYA Heading */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        {/* First Image – slightly less to the right */}
        <img
          ...
          className="rounded-xl shadow-md object-cover w-full h-[220px] lg:h-[400px] xl:h-[600px] object-[80%_center]"
        />
