export default function OmOssPage() {
  return (
    <div className="omoss-container px-6 py-12 max-w-full lg:max-w-[1600px] mx-auto">
      {/* NORYA Heading */}
      <h1 className="font-bold text-slate-900 mb-12 tracking-tight font-poppins text-[150px] lg:text-[220px] xl:text-[280px] leading-none text-center md:text-left">
        NORYA
      </h1>

      {/* Image Grid */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        {/* First Image – focus on right side when narrow */}
        <img
          ...
          className="rounded-xl shadow-md object-cover object-right w-full h-[220px] lg:h-[400px] xl:h-[500px]"
        />
        ...
        <img
          ...
          alt="Steigen landscape"
          className="rounded-xl shadow-md object-cover object-left w-full h-[220px] lg:h-[400px] xl:h-[500px]"
        />
        ...
        <img
          ...
          className="rounded-xl shadow-md object-cover w-full h-[220px] lg:h-[400px] xl:h-[500px]"
        />
      ...
      {/* Text */}
      <p className="text-lg lg:text-xl xl:text-2xl text-slate-700 leading-relaxed mb-6 font-poppins">
      ...
      <p className="text-lg lg:text-xl xl:text-2xl text-slate-700 leading-relaxed font-poppins">
