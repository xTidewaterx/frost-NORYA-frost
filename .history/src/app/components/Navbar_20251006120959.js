...
<Link
  href="/"
  className="group flex items-center h-full m-0 pl-2 pr-2 transition-all hover:bg-yellow-600 hover:rounded-b-md"
>
  <div className="flex items-center space-x-2 h-full">
    <img
      ...
      alt="NORYA Logo"
    />
    {(isHomePage ? showNorya : true) && ( // <-- always show on other pages
      <span
        id="navbarTextTarget"
