  ...
  return (
    <div className="omoss-container px-6 py-12 max-w-5xl mx-auto">
      ...
      <p className="text-lg text-slate-700 leading-relaxed mb-6 font-poppins">
        NORYA er et kreativt fellesskap dedikert til å styrke skapere i Nord-Norge. En kuratert, digital markedsplass hvor vi tror på samarbeid, historiefortelling, og digitale verktøy som bringer mennesker sammen.
      </p>
