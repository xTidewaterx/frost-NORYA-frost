export default function OmOss() {
  //https://firebasestorage.googleapis.com/v0/b/norland-a7730.appspot.com/o/pictureTest%2F39245156934_c57e00d11d_o.jpg?alt=media&token=c53fbed2-d819-434e-ac5d-13d09aad55cf
  return (
    <div className="omoss-container px-6 py-12 max-w-5xl mx-auto">
<h1 className="font-bold text-slate-900 mb-8 tracking-tight font-poppins text-[150px] md:text-xl leading-none text-center md:text-left">
  NORYA
</h1>
...
<img
  ...
  alt="Steigen landscape"
  className="rounded-xl shadow-md object-cover object-left w-full h-[220px]"
/>
